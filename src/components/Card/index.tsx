      ...
      <Card className={cn("inner xl:w-[70rem] w-[20rem] sm:w-[42rem] lg:w-[60rem] 2xl:backdrop-blur-[80px]", className)} {...props}>
        <CardHeader className="flex flex-row justify-between items-center m-0">
          <div>
            <svg
              ...
              height={84.9156249999999}
              viewBox="0 0 320 283.522364417264"
              {...props as React.SVGProps<SVGSVGElement>}
            >
              <defs id="SvgjsDefs1328" />
              <g
                id="SvgjsG1329"
                transform="matrix(4.872,0,0,4.872,53,20)"
                fill="#111111"
              >
              ...
              <g
                id="SvgjsG1330"
                transform="matrix(3.8567485817578264,0,0,3.8567485817578264,93.42975517424703,   -2.851217692121196)"
                fill="#fcfcfc"
              >
        ...
        <CardContent className="grid lg:grid-cols-4 grid-cols-1 gap-4 mt-2">
          <div className="col-span-3 flex flex-col gap-4">
            <CardTitle className="lg:text-[5rem] text-2xl md:text-3xl">BIENVENIDO</CardTitle>
            <CardDescription className="text-white lg:text-[1.2rem] text-sm md:text-xl leading-7 xl:mt-8">
              Soy Rafael Monroy, desarrollador front-end con una sólida experiencia en la creación de interfaces atractivas y funcionales. He trabajado en una variedad de proyectos, desde aplicaciones CRM, hasta plataformas inmobiliarias y sitios web informativos.
            </CardDescription>
            <CardDescription className="text-white lg:text-[1.2rem] text-sm md:text-xl leading-7">
              Mi pasión radica en el desarrollo de software que optimiza procesos y genera resultados medibles. Me encanta crear aplicaciones móviles que brindan accesibilidad a los usuarios y diseñar interfaces que combinan estética y funcionalidad.
            </CardDescription>
          </div>
          <CardContent className="col-span-1 p-0">
            <CardTitle className="text-[1.5rem] md:text-3xl">Proyectos</CardTitle>
        ...
        <CardFooter className="flex justify-end mt-4 flex-col items-end">
